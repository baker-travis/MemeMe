...
class MemeEditorViewController: UIViewController {
    ...
    ///
    /// - Parameter source: source to get image from (photo library, camera, etc.)
    ...
    /// Creates and saves meme for viewing in sent memes
    ///
    /// - Parameter memedImage: the image containing the meme (with text)
    ...
    /// Configures initial button state
    ...
    /// Sets up text field with a few default attributes
    ///
